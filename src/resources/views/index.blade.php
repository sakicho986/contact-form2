        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__input-radio">
              <input type="radio" name="gender" value="男性" checked="checked" value="{{ old('gender') }}"/>
              <div class ="male">男性</div>
              <input type="radio" name="gender" value="女性" />
              <div class ="female" value="{{ old('gender') }}">女性</div>
              <input type="radio" name="gender" value="その他" value="{{ old('gender') }}" />
